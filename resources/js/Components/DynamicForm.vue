...
.el-select__placeholder {
    text-align: v-bind('isRTL ? "right" : "left"');
}

[dir="rtl"] .el-select .el-input__wrapper {
    text-align: right !important;
}

[dir="rtl"] .el-select__tags {
    text-align: right !important;
}

[dir="rtl"] .el-select-dropdown__item {
    text-align: right !important;
}

[dir="ltr"] .el-select .el-input__wrapper {
    text-align: left !important;
}

[dir="ltr"] .el-select__tags {
    text-align: left !important;
}

[dir="ltr"] .el-select-dropdown__item {
    text-align: left !important;
}
</style>
