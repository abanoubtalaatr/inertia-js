                ...
                <el-form :model="form" @submit.prevent="update" label-position="top" class="row g-3">
                    ...
                    <div class="col-md-4">
                        <el-form-item :label="$t('email')">
                            <el-input v-if="isSuperAdmin(props.specialist)" v-model="form.email" type="email" disabled
                    ...
                    <!-- Password -->
                    <div class="col-md-4" v-if="!isSuperAdmin(props.specialist)">
...
const form = useForm({
    ...
    phone: props.specialist?.phone,
    password: "",
    password_confirmation: "",
    selectedRoles: props.specialistRoles,
});
...
const isSuperAdmin = (specialist) => {
    return specialist.email === "admin@admin.com";
};

const update = () => {
    show_loader.value = true;
    form.post(route("specialists.update", { specialist: props.specialist.id }), {
        onSuccess: () => {
